        ...
        <div dir="rtl" className="dropdown col-sm-6">
            <div className="input-group mb-3 ">
                ...
                <ul className="dropdown-menu scrollable-menu">
                    ...
                    <li><a className="dropdown-item" dir='rtl' onClick={() => {handlePeak("א'" )}}>{"א'"}</a></li>
                    <li><a className="dropdown-item" dir='rtl' onClick={() => {handlePeak("ב'")}}>{"ב'"}</a></li>
                    <li><a className="dropdown-item" dir='rtl' onClick={() => {handlePeak("ג'")}}>{"ג'"}</a></li>
                    <li><a className="dropdown-item" dir='rtl' onClick={() => {handlePeak("ד'")}}>{"ד'"}</a></li>
                    <li><a className="dropdown-item" dir='rtl' onClick={() => {handlePeak("ה'")}}>{"ה'"}</a></li>
                    <li><a className="dropdown-item" dir='rtl' onClick={() => {handlePeak("ו'")}}>{"ו'"}</a></li>
                    <li><a className="dropdown-item" dir='rtl' onClick={() => {handlePeak("שבת")}}>{"שבת"}</a></li>
                </ul>
            </div>
        </div>
        <div dir="rtl" className="dropdown col-sm-6">
